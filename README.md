...
```
$ java -jar target/bus-0.12.4.jar; echo $?
$ #                              ^   ^   ^
$ #                              |   |   |
$ # -----------------------------+---+---+
$ # Whilst this is not necessary, it's beneficial knowing the exit code.
